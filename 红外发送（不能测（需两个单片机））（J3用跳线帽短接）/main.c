...
const uchar TabHL2[12]={0xcf,0xe7,0x85,0xef,0xc7,0xa5,0xbd,0xb5,0xad,0xff,0x00,0x59};//数据码码表1-9&2字节用户码
...
void xuexiban_1()	//00110000 		发送”1“的全部信号
 {
     ...
     Send8Bit(TabHL1[0]);
	 Send8Bit(TabHL2[0]);//数据反码（校验用）（直接用的原码，这样方便简单，但是稳定性不好）
	 //delay(1);
	 //khz_2(10) ;    //0.56ms的38kHZ的脉冲
 }
